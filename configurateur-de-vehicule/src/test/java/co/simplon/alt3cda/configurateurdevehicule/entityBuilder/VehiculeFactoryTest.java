...
//   @Autowired
//   private VehicleFactory vehiculeFactory;
...
//     assertNotNull(vehiculeFactory.saveVehicle(vehicleDTO));
//   }
...
//     assertThrows(IllegalArgumentException.class, () -> vehiculeFactory.saveVehicle(vehicleDTO));
//   }
